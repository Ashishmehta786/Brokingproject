...
export const Login = () => {
  ...
  <h2 className="text-2xl font-semibold mb-6 mt-5">Login</h2>
  <form className="space-y-10">
    ...
    <div>
      <button
        type="submit"
        className="w-full py-2 my-3 rounded-md focus:outline-none bg-yellow-500 hover:bg-yellow-600 text-slate-950"
      >
        Login
      </button>
          <div >
    <Link to="/Signup"
      ...
      >
        <button  className="w-full py-2 my-3 rounded-md focus:outline-none  text-slate-700" >New user ? Signup</button>
